...
if(NOT "/home/mali/hokuyo_repo/hokuyo_plus/ros/hokuyo_ws/devel/include;/home/mali/hokuyo_repo/hokuyo_plus/ros/hokuyo_ws/src/gazebo_sensor_collection/include;/usr/include " STREQUAL " ")
  set(gazebo_sensor_collection_INCLUDE_DIRS "")
  set(_include_dirs "/home/mali/hokuyo_repo/hokuyo_plus/ros/hokuyo_ws/devel/include;/home/mali/hokuyo_repo/hokuyo_plus/ros/hokuyo_ws/src/gazebo_sensor_collection/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_sensor_collection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mali/hokuyo_repo/hokuyo_plus/ros/hokuyo_ws/src/gazebo_sensor_collection/${idir}'.  ${_report}")
    endif()
